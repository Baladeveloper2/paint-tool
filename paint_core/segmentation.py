...
class SegmentationEngine:
    ...
    def set_image(self, image_rgb):
        ...
        # Integrate advanced pipeline
        self.pipeline.set_image(image_rgb)
    ...
    def generate_mask(self, point_coords=None, point_labels=None, box_coords=None, level=None, is_wall_only=False, cleanup=True, is_wall_click=False):
        ...
        # Apply Architectural Topology Constraints (Planar merging, exclusions, gap filling)
        if is_wall_only or is_wall_click:
            best_mask = self.pipeline.process_wall_selection(best_mask, point_coords)
